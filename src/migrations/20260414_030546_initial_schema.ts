...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_accomplishments_category" AS ENUM('leadership', 'technical', 'business', 'exit');
  ...
  CREATE TABLE "accomplishments" (
  	...
  	"category" "enum_accomplishments_category" NOT NULL,
  	"sort_order" numeric DEFAULT 0,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  
  CREATE TABLE "roles_positions" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  ...
  ALTER TABLE "roles_positions" ADD CONSTRAINT "roles_positions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."roles"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "roles_key_wins" ADD CONSTRAINT "roles_key_wins_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."roles"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "roles" ADD CONSTRAINT "roles_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_accomplishments_fk" FOREIGN KEY ("accomplishments_id") REFERENCES "public"."accomplishments"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "profile" ADD CONSTRAINT "profile_headshot_id_media_id_fk" FOREIGN KEY ("headshot_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "accomplishments_updated_at_idx" ON "accomplishments" USING btree ("updated_at");
  CREATE INDEX "accomplishments_created_at_idx" ON "accomplishments" USING btree ("created_at");
  CREATE INDEX "roles_positions_order_idx" ON "roles_positions" USING btree ("_order");
  CREATE INDEX "roles_positions_parent_id_idx" ON "roles_positions" USING btree ("_parent_id");
  CREATE INDEX "roles_key_wins_order_idx" ON "roles_key_wins" USING btree ("_order");
  CREATE INDEX "roles_key_wins_parent_id_idx" ON "roles_key_wins" USING btree ("_parent_id");
  CREATE INDEX "roles_logo_idx" ON "roles" USING btree ("logo_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_accomplishments_id_idx" ON "payload_locked_documents_rels" USING btree ("accomplishments_id");
  ...
  CREATE INDEX "profile_headshot_idx" ON "profile" USING btree ("headshot_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "accomplishments" CASCADE;
  DROP TABLE "roles_positions" CASCADE;
  DROP TABLE "roles_key_wins" CASCADE;
  ...
  DROP TYPE "public"."enum_accomplishments_category";`)
}
